...
#ifndef CFG_Config_IIC10_H
#define CFG_Config_IIC10_H
...
#define _C600_IIC10_DIVISOR                (0xC600U)
#define IIC10_WAITTIME                     (16U)    /* wait for 5us as default,
                                                       please change the waiting time value according to the system */
#define IIC10_WAITTIME_2                   (66U)    /* wait for 20us as default,
                                                       please change the waiting time value according to the system */
